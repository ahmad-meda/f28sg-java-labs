...
public class DLinkedList {
	...
	/**
	 * Implementation of insertion sort using D-linked lists
	 */
	public void insertionSort() {
		//Declaring a head pointer
		Node HeadPointer = headNode;
		//Declaring a tail pointer
		Node TailPointer = tailNode;
		//Base case if condition
		if (HeadPointer != TailPointer) {
			Node present_node = HeadPointer.nextNode;
			while (present_node != null) {
				Node temp_1 = present_node.getPrevNode();
				while(temp_1 != null && present_node.getValue() < temp_1.getValue()) {
					temp_1 = temp_1.prevNode;
				}
				int var_1 = delete(present_node);
				insertAfter(temp_1, var_1);
