...
public class Hanoi {
	...
	public void moveOneRing(int from, int to) {
		/* TODO */
		// pops the ring from tower entered("from") and pushes the ring to the tower entered("to")
	...
	public void movePile(int n, int from, int to, int via) {
		/* TODO */
		if (n == 1) {
			//base case of having one ring and to stop the recursion from running infinitely
			moveOneRing(from,to);
		}else {
			//Use of recursion to solve the case of Hanoi
