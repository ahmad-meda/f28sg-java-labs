...
public class DLinkedList {
	...
	public void reverse(){
		if (headNode != null) {
			Node value_1 = headNode;
			Node value_2 = headNode.getNextNode();
			
			//reversing the queue
			value_1.nextNode = null;
			value_1.prevNode = value_2;
			
			//While loop to change the previous address and the next address of each node
			while (value_2 != null) {
				value_2.prevNode = value_2.nextNode;
				value_2.nextNode = value_1;
				value_1 = value_2;
				value_2 = value_2.prevNode;
			}
			
			//reversing the head and tail pointers
			tailNode = headNode;
			headNode = value_1;
		}
	}	
