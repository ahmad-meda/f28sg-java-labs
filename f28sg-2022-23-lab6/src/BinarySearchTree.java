...
public class BinarySearchTree {
	...
	private class BSTNode { // private class to hold a tree node
		...
		public void inOrderTraversalPrint() {
			//Declare a condition if the left child is not null to traverse through
			if (leftChild != null)
			    leftChild.inOrderTraversalPrint();
			//Print out he value
			System.out.println(this.value);
			//Declare a condition if the right child is not null to traverse through
			if (rightChild != null)
